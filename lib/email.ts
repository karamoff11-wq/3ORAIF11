// lib/email.ts
// Resend transactional email utility — lazily imports Resend to avoid
// static-analysis errors during Next.js Turbopack builds.
...
const FROM_ADDRESS = () =>
  process.env.RESEND_FROM_EMAIL ?? 'العُريف <noreply@al-ureef.com>'
...
<body style="margin:0;padding:0;background:#06061a;font-family:system-ui,-apple-system,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:24px;padding:40px;margin-bottom:24px;">
      <h2 style="color:white;font-size:22px;font-weight:900;margin:0 0 12px;">أهلاً وسهلاً، ${username}! 🎉</h2>
...
<body style="margin:0;padding:0;background:#06061a;font-family:system-ui,-apple-system,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:rgba(255,255,255,0.04);border:1px solid ${planColor}30;border-radius:24px;padding:40px;margin-bottom:24px;">
      <h2 style="color:white;font-size:20px;font-weight:900;margin:0 0 12px;">مبروك ${username}! 🎊</h2>
      <p style="color:rgba(255,255,255,0.6);font-size:15px;line-height:1.7;margin:0 0 28px;">
        تم تفعيل اشتراك <strong style="color:${planColor};">العُريف ${planLabel}</strong> بنجاح.
      </p>

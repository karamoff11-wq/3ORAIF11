...
const SMART_CAT_NAMES = [
  ...
  'أسرار العائلة', 'قصة حبنا', 'صاحب عيد الميلاد', 'أيام الجامعة', 
  'أقوال مأثورة للشلة', 'جرائم المطبخ', 'أسرار الطفولة', 'مغامرات منتصف الليل',
  'أساطير ومقالب', 'عجائب المكتب'
]
...
const SMART_QUESTIONS = [
  ...
  'ما هي أسوأ كذبة كذبها في المدرسة أو الجامعة؟',
  'من هو أكثر شخص في الشلة يتأخر دائمًا عن المواعيد؟',
  'ما هي الأغنية التي يدندنها دائمًا في السيارة؟',
  'لو فتحنا سجل البحث في هاتفه الآن، ما هي أغرب كلمة سنلقاها؟',
  'ما هو أغرب تبرير قاله للهروب من عزومة أو خروجة؟',
  'ما هي العادة الغريبة التي يفعلها عندما يكون متوتراً؟',
  'لو تم القبض عليه يوماً ما، ما هي التهمة الأكثر توقعاً؟',
  'ما هي أسوأ تجربة طبخ قام بها وانتهت بكارثة؟',
  'من هو الشخص الذي يتصل به دائماً في الأوقات الصعبة؟',
  'ما هي المقولة الأسطورية التي يكررها عند كل نصيحة؟',
  'ما هو أكثر موقف محرج تعرض له في مكان عام؟',
  'لو كان حيواناً أليفاً، ما هو الحيوان الذي يمثله بالضبط؟',
  'ما هو الشيء الذي يخاف منه بشدة رغم أنه غير منطقي؟',
  'ما هي أكثر قصة درامية ألفها ليحصل على إجازة من العمل؟',
  'من هو أكثر فنان أو ممثل يعتقد أنه يشبهه؟',
  'ما هو اللقب الغريب أو المضحك الذي أطلقناه عليه في الطفولة؟',
  'ما هي أكثر مغامرة مجنونة قمنا بها في منتصف الليل؟',
  'لو كان عالقاً في جزيرة مهجورة، ما هما الشيئان اللذان سيأخذهما؟',
  'ما هي النصيحة المالية الكارثية التي أعطاها لأحد الأصدقاء؟',
  'ما هي أسوأ قصة شعر أو موضة اتبعها في الماضي؟',
  'من هو الشخص الذي يشاركه دائماً أسراره التافهة؟',
  'ما هو التطبيق الذي يقضي عليه أكثر من 5 ساعات يومياً؟',
  'ما هي الوجبة السريعة التي يمكنه تناولها يومياً دون ملل؟',
  'لو أصبح مشهوراً يوماً ما، ما هو سبب شهرته الغريب؟',
  'ما هي الجملة التي يكتبها دائماً في رسائل الواتساب؟',
  'ما هو أكثر تخصص أو مجال يدّعي أنه خبير فيه وهو لا يفقه شيئاً؟',
  'ما هو أكثر موقف شجاع قام به وفاجأ الجميع؟',
  'ما هي الهواية الغريبة التي جربها واعتزلها بعد أسبوع؟',
  'لو كان مديراً لشركة، ما هو أول قرار غريب سيتخذه؟',
  'ما هو أكثر فيلم شاهده أكثر من 10 مرات يحفظ حواره بالكامل؟',
  'ما هي الخرافة أو الأسطورة التي كان يصدقها حتى سن متأخرة؟',
  'ما هو أكثر شيء يثير غضبه في ثوانٍ معدودة؟',
  'ما هي الهدية التي يحلم بها وينتظرها في كل عيد ميلاد؟',
  'لو كان يملك آلة زمن، إلى أي سنة سيسافر ولماذا؟',
  'ما هو أكثر مقلب مضحك نفذناه فيه أو نفذه فينا؟',
  'ما هي الرياضة التي يتابعها بشغف رغم أنه لا يمارسها أبداً؟',
  'ما هو أكثر صوت أو حركة تزعجه أثناء تناول الطعام؟',
  'لو خيّر بين العيش في كوخ منعزل أو مدينة صاخبة، ماذا سيختار؟',
  'ما هي الأكلة الغريبة التي يخترعها في منتصف الليل؟',
  'ما هي الكلمة الإنجليزية التي ينطقها دائماً بطريقة مضحكة؟',
  'من هو الشخص الذي يعتبره قدوته في الحياة ورغم ذلك يمازحه دائماً؟',
  'ما هي أكثر صورة محرجة له موجودة في هواتفنا؟',
  'لو شارك في برنامج مسابقات، ما هي المسابقة التي سيفوز بها حتماً؟',
  'ما هو أكثر سر يعرفه الجميع ويظن هو أنه مخفي بذكاء؟',
  'ما هي العبارة التي يستخدمها دائماً لإنهاء النقاشات الطويلة؟',
  'ما هو أكثر شيء اشتراه وندم عليه بعد 5 دقائق؟'
]
        ...
        {step === 2 && (
          ...
          >
            ...
            <button 
              ...
              onClick={() => setStep(3)}
              className="btn-aurora btn-aurora-studio px-12 py-5 font-black text-sm uppercase tracking-widest text-white shadow-2xl disabled:opacity-20"
            >
          ...
          >
            ...
            <div className="lg:col-span-3 space-y-8">
               ...
               <div className="flex justify-between items-center">
                  ...
                  <button 
                    onClick={() => setStep(4)} 
                    className="btn-aurora btn-aurora-studio px-12 py-4 font-black text-xs uppercase tracking-widest text-white shadow-2xl"
                  >
                  ...
                  <button 
                    onClick={async () => { 
                      ...
                      setTimeout(() => {
                        ...
                        setSessionName('')
                        setCategories([])
                        window.dispatchEvent(new Event('creations_updated'))
                        toast.success(isRtl ? 'تم حفظ الجلسة بنجاح!' : 'Session saved successfully!')
                        router.push('/dashboard')
                      }, 1500)
                    }}
                    className="btn-aurora btn-aurora-emerald flex-1 py-5 font-black text-sm uppercase text-white shadow-2xl"
                  >
